...
//   });
// });
(function(){WebFont.load({google:{families:["Andada","Andada:700"]},custom:{families:["trackregular","trackitalic","thetinke"]},loading:function(){$("header h1, header h2").slabText({viewportBreakpoint:380})}});var e=$("header h2"),t=$("section.extra-info"),n=$(".bubble").hide();e.addClass("animated");t.on("click","button",function(e){e.preventDefault();var t=$(this);t.hasClass("icon-beaker")?$(".about-this-site").fadeOut(100,function(){$(".technologies").fadeIn(200)}):$(".technologies").fadeOut(100,function(){$(".about-this-site").fadeIn(200)})})})();